...
(function () {
  ...
  const CMD_ITEMS = [
    ...
    { group: 'Requests', icon: 'flask', label: 'Diesel — #CHM-155', sub: 'Approved · PS2-Dompta', req: 'CHM-155' },
    ...
    { group: 'People', icon: 'user', label: 'Oumar Cheikh', sub: 'OI Safety · PS2-Dompta' }
  ];
  ...
  const ACTIVITY = [
    ...
    { type: 'approved', icon: 'check-circle', cls: 'success', text: '<strong>Oumar Cheikh</strong> approved <span class="mono">#CHM-150</span> at <strong>OI Safety</strong>', meta: 'Sodium Hypochlorite · PRS-Kribi', time: '5h ago' }
  ];
